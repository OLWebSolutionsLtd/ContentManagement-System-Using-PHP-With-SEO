...
if(isset($_POST['submit'])){
	...
	mysql_query("UPDATE democms_pages SET pageTitle='$title', pageSlug='$pageSlug', pageCont='$content' WHERE pageID='$pageID'");
...
$q = mysql_query("SELECT * FROM democms_pages WHERE pageID='$id'");
